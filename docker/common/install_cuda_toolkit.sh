...
reinstall_rockylinux_cuda() {
    ...
    wget --show-progress --no-check-certificate https://cuda-repo.nvidia.com/release-candidates/kitpicks/cuda-r13-0/${CUDA_VER_SHORT}/041/local_installers/cuda_${CUDA_VER}_linux.run
